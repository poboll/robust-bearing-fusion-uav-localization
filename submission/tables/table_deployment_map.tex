\begin{table}[!htbp]
\centering
\caption{Passive-sensing deployment scenarios and dominant corruption sources.}
...
Degraded navigation and asynchronous payload operation \cite{chen2025research,peng2024trajectory} & Pose error, timestamp mismatch, intermittent detections, bearing drift & This failure pattern is matched directly by pose uncertainty, sensor bias, pseudo-physical replay, and PyBullet replay experiments. \\
