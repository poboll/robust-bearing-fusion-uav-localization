...
- `submission/mdpi_manuscript/manuscript_mdpi.tex` was rebuilt around the uncertainty-aware passive-localization story and compiled successfully.
- `submission/manuscript/manuscript_final.tex` and `submission/manuscript/manuscript_final.md` were synchronized to the same narrative, title, abstract, and scope boundary.
- `submission/manuscript/manuscript_final.pdf` was recompiled successfully from the synchronized backup LaTeX source.
...
- The main story is uncertainty-aware passive localization under unreliable bearings, not runtime advantage.
...
The current project now has a complete MDPI-format package and a synchronized backup manuscript. Portal-specific requirements should be checked one more time immediately before submission because journal guides and upload fields can change.
